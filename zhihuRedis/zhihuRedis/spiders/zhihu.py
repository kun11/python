...
from ..items import ZhihuredisItem
...
class ZhihuSpider(scrapy.Spider):
    ...
    user_query = "locations,employments,gender,educations,business,voteup_count,thanked_Count," \
                 ...
                 "avatar_hue,answer_count,articles_count,pins_count,question_count," \
                 "columns_count,commercial_question_count,favorite_count,favorited_count," \
                 "logs_count,marked_answers_count,marked_answers_text,message_thread_token," \
                 "account_status,is_active,is_bind_phone,is_force_renamed,is_bind_sina," \
                 "is_privacy_protected,sina_weibo_url,sina_weibo_name,show_sina_weibo," \
                 "is_blocking,is_blocked,is_following,is_followed,mutual_followees_count," \
                 "vote_to_count,vote_from_count,thank_to_count,thank_from_count,thanked_count," \
                 "description,hosted_live_count,participated_live_count,allow_message," \
